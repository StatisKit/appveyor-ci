...
if "%PLATFORM%"=="x86" if "%MINICONDA%"=="2" curl https://repo.continuum.io/miniconda/Miniconda2-latest-Windows-x86.exe -o miniconda.exe
if %errorlevel% neq 0 exit /b %errorlevel%
if "%PLATFORM%"=="x86" if "%MINICONDA%"=="3" curl https://repo.continuum.io/miniconda/Miniconda3-latest-Windows-x86.exe -o miniconda.exe
if %errorlevel% neq 0 exit /b %errorlevel%
